...
export const BrandsRu: React.FC = () => {
  ...
  const kuzovnyeBrands = [
    { name: "Body Brand 1", category: "Бамперы", logo: "/kuzov1.png" },
    { name: "Body Brand 2", category: "Фары", logo: "/kuzov2.png" },
    { name: "Body Brand 3", category: "Зеркала", logo: "/kuzov3.png" },
    { name: "Body Brand 4", category: "Молдинги", logo: "/kuzov4.png" },
  ];
