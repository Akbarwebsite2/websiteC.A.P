    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-5xl sm:text-6xl lg:text-8xl font-black text-white mb-8 leading-tight tracking-tight">
          <div className="text-blue-800 text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black mb-6 tracking-widest" style={{ fontFamily: 'Russo One, Orbitron, Impact, Arial Black, sans-serif', fontWeight: '900', textShadow: '3px 3px 6px rgba(0,0,0,0.7)' }}>
            Common Auto Parts
          </div>
        </h1>
