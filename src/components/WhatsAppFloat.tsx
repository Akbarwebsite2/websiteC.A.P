...
export const WhatsAppFloat: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 right-4 bg-green-500 hover:bg-green-600 text-white px-3.5 py-2.5 sm:p-4 rounded-2xl sm:rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110 z-50 flex items-center space-x-1.5 content-reveal delay-4"
      aria-label="WhatsApp"
    >
