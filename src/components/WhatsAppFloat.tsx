...
export const WhatsAppFloat: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110 z-50 flex items-center space-x-2 pulse-glow content-reveal delay-4"
      aria-label="WhatsApp"
    >
